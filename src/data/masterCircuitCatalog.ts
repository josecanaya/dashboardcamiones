    ...
    grupos: [
      {
        ...
        circuitos: [
          ...
          { codigo: 'A3V0', codigosEquivalentes: ['A3'], nombre: 'Silos Kepler', codigoCircuito: 'CIR_A3_V0', codigoVuelta: 'VUE_A3_V0', tipo: 'recepcion', subtipo: 'solidos', destino: 'Silos Kepler', descripcion: 'Descarga sólido en Silos Kepler.', secuenciaCamaras: ['S0', 'S1', 'S2', 'S4', 'S4'] },
      ...
      },
      {
        ...
        circuitos: [
          ...
          { codigo: 'B3V0', codigosEquivalentes: ['B3'], nombre: 'Silos Kepler', codigoCircuito: 'CIR_B3_V0', codigoVuelta: 'VUE_B3_V0', tipo: 'despacho', subtipo: 'solidos', destino: 'Silos Kepler', descripcion: 'Carga sólido en Silos Kepler.', secuenciaCamaras: ['S0', 'S1', 'S2', 'S4', 'S4'] },
