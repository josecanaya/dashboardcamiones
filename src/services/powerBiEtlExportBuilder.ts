/**
 * Capa: exportación Power BI — funciones puras (CSV, nombres, ZIP bytes).
 * Aptas para Vitest y CLI Node; sin window/document.
 */
...
/**
 * ZIP síncrono (`level: 0` = STORE). Sin dependencias de DOM; usable desde CLI.
 */
