...
const PLANT_MAP: Record<string, PlantNormalized> = {
  ...
  /** Excel operativo: “San Lorenzo” = terminal de embarque (puerto). */
  'SAN LORENZO': 'TERMINAL_EMBARQUE',
  /** Excel operativo: “Planta San Lorenzo” = planta Ricardone. */
  'PLANTA SAN LORENZO': 'RICARDONE',
  'TERMINAL PORTUARIA': 'TERMINAL_EMBARQUE',
...
const PLATFORM_MAP: Record<string, string> = {
  ...
  ACEITE_OSL: 'ACEITE_OSL',
  ACEITEOSL: 'ACEITE_OSL',
  'ACEITE PTO': 'ACEITE_PTO',
  ACEITE_PTO: 'ACEITE_PTO',
  ACEITEPTO: 'ACEITE_PTO',
  ACEITE: 'ACEITE',
}
