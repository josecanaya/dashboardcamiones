...
/**
 * Matriz ejecutiva derivada de CIRCUIT_CATALOG (Fase 3.3). Una sola fuente de verdad.
 */
export const EXECUTIVE_CIRCUIT_MATRIX: Record<string, ExecutiveCircuitConfig> = Object.fromEntries(
  Object.entries(CIRCUIT_CATALOG).map(([code, entry]) => [code, toExecutiveCircuitConfig(entry)])
)
